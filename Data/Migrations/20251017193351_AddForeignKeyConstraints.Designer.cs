...
namespace SatOps.Data.Migrations
{
    ...
    [Migration("20251017193351_AddForeignKeyConstraints")]
            ...
            modelBuilder.Entity("SatOps.Modules.Groundstation.GroundStation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ApiKeyHash = "",
                            ApplicationId = new Guid("7834a117-7061-4501-aa46-4b8e1330e0d2"),
                            CreatedAt = new DateTime(2025, 10, 17, 19, 33, 51, 553, DateTimeKind.Utc).AddTicks(9853),
                            HttpUrl = "http://aarhus-groundstation.example.com",
                            IsActive = false,
                            Name = "Aarhus",
                            UpdatedAt = new DateTime(2025, 10, 17, 19, 33, 51, 553, DateTimeKind.Utc).AddTicks(9853)
                        });
                });
            ...
            modelBuilder.Entity("SatOps.Modules.Operation.ImageData", b =>
                {
                    ...
                    b.Property<int?>("GroundStationId1")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SatOps.Modules.Satellite.Satellite", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 10, 17, 19, 33, 51, 553, DateTimeKind.Utc).AddTicks(9968),
                            LastUpdate = new DateTime(2025, 10, 17, 19, 33, 51, 553, DateTimeKind.Utc).AddTicks(9968),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 10, 17, 19, 33, 51, 553, DateTimeKind.Utc).AddTicks(9970),
                            LastUpdate = new DateTime(2025, 10, 17, 19, 33, 51, 553, DateTimeKind.Utc).AddTicks(9970),
                            Name = "SENTINEL-2C",
                            NoradId = 60989,
                            Status = 0,
            ...
            modelBuilder.Entity("SatOps.Modules.Operation.ImageData", b =>
                {
                    ...
                    b.HasOne("SatOps.Modules.Groundstation.GroundStation", null)
                        .WithMany("Images")
                        .HasForeignKey("GroundStationId1");
                    ...
                    b.HasOne("SatOps.Modules.Satellite.Satellite", null)
                        .WithMany("Images")
